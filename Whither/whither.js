...
( function () {
	...
	var levelData = [
		...
		// Level 20
		{
			...
			fadewalls : [
				[ 2, 5, STEP3 ], [ 3, 3, STEP12 ], [ 7, 6, STEP5 ], [ 5, 5, STEP6 ]
			],
	...
	W = {
		...
		init : function () {
			...
			start( 20 );                                                           // TEMPORARY CHANGE TO VIEW FINAL LEVEL ONLY, REPLACE WITH level TO PLAY EVERY LEVEL
		},
